window.document.body.onload = function(){
    ...
    // O comando slipt aplicado a variavel valores é capaz de quebrar
    // os números digitados pelo o usuario onde há virgula e assim 
    // gerar um array com estes números
    // var n = valores.split(",");
    // console.log(n);
    // var np = [];
